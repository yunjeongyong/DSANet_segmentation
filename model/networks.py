...
class UnetGenerator(nn.Module):
    ...
    def forward(self, input):
        ...
        result1, result2 = torch.chunk(output, 2, dim=1)
...
class UnetSkipConnectionBlock(nn.Module):
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None,
        ...
        if outermost:
            print('outermost inside!!!! True!!!', outermost)
...
if __name__ == "__main__":
    ...
    norm='batch'
    norm_layer = get_norm_layer(norm_type=norm)
    # net = UnetGenerator(input_nc=3, output_nc=6, num_downs=7, ngf=64, norm_layer=norm_layer, use_dropout=False)
    # result1, result2 = net(img)
    # print('result1.shape',result1.shape)
    # print('result2.shape', result2.shape)
    model = ResnetGenerator(input_nc=6, output_nc=3, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=9)
